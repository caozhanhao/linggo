...
temp_value_chat = '''chance，以该单词使用json格式输出一道大学英语选择题（仅有题目，abcd四个选项和答案，不包括任何代码和回答注释），json生成示例： { "question": "<Question>", "options": { "A": "<Option A>", "B": "<Option B>", "C": "<Option C>", "D": "<Option D>" }, "answer": "<Correct Answer>" }'''
